...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2025 at 11:52 AM
...
(1, 'Jhon', 'Doe', '01700000000', 'admin@admin.com', '2021-08-22-61214c4e9e0cb.png', '$2a$12$NQBXTu9.U.jS0McEJPVEZuVcC2eAorHB8vQXCPlbcXuJM/mb9RpfO', 'H5i3SRc6LWzqH22QqpTTi96ptQzxvOTVZeHAtfZCmgRiFtFfnlL6SgrJUbzX', '2021-05-08 04:30:27', '2021-08-22 00:56:14', 1, NULL),
...
INSERT INTO `modules` (`id`, `module_name`, `module_type`, `thumbnail`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Food', 'food', NULL, 1, NULL, NULL),
(2, 'Grocery', 'grocery', NULL, 1, NULL, NULL),
(3, 'Pharmacy', 'pharmacy', NULL, 1, NULL, NULL),
(4, 'Shop', 'shop', NULL, 1, NULL, NULL),
(5, 'Parcel', 'parcel', NULL, 1, NULL, NULL);
...
INSERT INTO `stores` (`id`, `name`, `email`, `phone`, `address`, `latitude`, `longitude`, `status`, `created_at`, `updated_at`, `order_count`, `rating_count`, `avg_rating`) VALUES
(1, 'City Mart', 'citymart@gmail.com', '01811111111', 'Uttara, Dhaka', '23.8709', '90.3982', 1, '2025-12-16 16:26:45', '2025-12-16 16:26:45', 20, 10, 4.60),
(2, 'Fresh Shop', 'freshshop@gmail.com', '01922222222', 'Mirpur, Dhaka', '23.8067', '90.3686', 1, '2025-12-16 16:26:45', '2025-12-16 16:26:45', 0, 0, 0.00);
...
ALTER TABLE `stores`
ADD COLUMN `module_id` BIGINT(20) UNSIGNED NULL AFTER `id`;


ALTER TABLE `stores`
ADD INDEX `stores_module_id_index` (`module_id`);

ALTER TABLE `stores`
ADD CONSTRAINT `stores_module_id_foreign`
