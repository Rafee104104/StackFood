            ...
            <div id="passwordDiv" class="card mb-3 mb-lg-5">
                ...
                <div class="card-body">
                    ...
                    <form id="changePasswordForm" action="{{env('APP_MODE')!='demo'?route('admin.settings-password'):'javascript:'}}" method="post"
                        ...
                        <!-- End Form Group -->
                        @php
                        $err1 = "form_alert('changePasswordForm','".translate('messages.want_to_update_admin_password')."')";
                        $err2 = "call_demo()";
                        @endphp
                        <div class="d-flex justify-content-end">
                            <button type="button" onclick="{{$mode!='demo'?$err1:$err2}}" class="btn btn-primary">{{translate('messages.save')}}</button>
                        </div>
                    </form>
                    <!-- End Form -->
                </div>
