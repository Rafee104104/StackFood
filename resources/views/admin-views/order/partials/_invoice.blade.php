        ...
        <div class="col-5">
            ...
            <div class="row mt-3">
                ...
                <div class="col-12">
                    ...
                    <span>
                        {{translate('messages.sender')}} {{translate('messages.name')}} : {{isset($address['contact_person_name'])?$address['contact_person_name']: ($order->customer['f_name']??'').' '.($order->customer['l_name']??'')}}
                    </span><br>
                    <span>
                        {{translate('messages.phone')}} : {{isset($address['contact_person_number'])?$address['contact_person_number']: ($order->customer['phone']??'')}}
                    </span><br>
                    <span class="text-break">
                        {{translate('messages.address')}} : {{isset($address['address'])?$address['address']:''}}
                    </span>
                    <br>
                    <br>
                    ...
                    <span>
                        {{translate('messages.receiver')}} {{translate('messages.name')}} : {{isset($address['contact_person_name'])?$address['contact_person_name']: ($order->customer['f_name']??'').' '.($order->customer['l_name']??'')}}
                    </span><br>
                    <span>
                        {{translate('messages.phone')}} : {{isset($address['contact_person_number'])?$address['contact_person_number']: ($order->customer['phone']??'')}}
                    </span><br>
                        ...
                        <td class="text-break">
                            ...
                            <div class="font-size-sm text-body">
                                ...
                                <span class="font-weight-bold">
                                    {{$addon['quantity'] ?? 0}} x {{\App\CentralLogics\Helpers::format_currency($addon['price'] ?? 0)}}
                                </span>
                            </div>
                            @php($add_ons_cost+=(($addon['price']??0)*($addon['quantity']??0)))
                            @endforeach
                        </td>
                        <td style="width: 28%">
