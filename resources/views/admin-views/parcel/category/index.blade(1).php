...
<div class="content container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h5>{{translate('messages.Add_new_parcel_category')}}</h5>
        </div>
        <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$category->id}}">
                                <input type="checkbox"
                                    class="toggle-switch-input toggle-category-status"
                        ...
                        <td>
                            ...
                            <a class="btn btn-sm btn-white delete-category"
                                data-id="category-{{ $category->id }}"
                                data-message="{{ translate('messages.want_to_delete_this_category') }}"
                                title="{{ translate('messages.delete') }} {{ translate('messages.category') }}">
