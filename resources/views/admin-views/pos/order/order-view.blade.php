            ...
            <div class="col-sm mb-2 mb-sm-0">
                ...
                <div class="mt-2">
                    ...
                    <div class="hs-unfold float-right">
                        ...
                        <a class="btn btn-sm btn-primary" onclick="order_status_change_alert(b)" href="javascript:">{{translate('messages.Proceed_for_cooking')}}</a>
                        @elseif ($order['order_status']=='processing')
                        <a class="btn btn-sm btn-primary" onclick="order_status_change_alert(c)" href="javascript:">{{translate('messages.make_ready_for_handover')}}</a>
                        @elseif ($order['order_status']=='handover' && $order['order_type']=='take_away')
                        <a class="btn btn-sm btn-primary" onclick="order_status_change_alert(d)" href="javascript:">{{translate('messages.maek_delivered')}}</a>
                        @endif
                    </div>
                    <!-- End Unfold -->
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <a class="avatar avatar-xl mr-3" href="{{route('admin.item.view',$detail->item['id'])}}">
                            <script>
                                const img4 = "{{ asset('assets/admin/img/160x160/img2.jpg') }}";
                            </script>
                            <img class="img-fluid"
                                src="{{asset('storage/product')}}/{{$detail->item['image']}}"
                                onerror="this.src=img4"
                    ...
                    <div class="media">
                        <div class="avatar avatar-xl mr-3">
                            <script>
                                const img3 = "{{ asset('assets/admin/img/160x160/img2.jpg') }}";
                            </script>
                            <img class="img-fluid"
                                src="{{asset('storage/campaign')}}/{{$detail->campaign['image']}}"
                                onerror="this.src=img3"
                                alt="Image Description">
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="media align-items-center" href="javascript:">
                        <div class="avatar avatar-circle mr-3">
                            <script>
                                const img2 = "{{ asset('assets/admin/img/160x160/img1.jpg') }}";
                            </script>
                            <img
                                class="avatar-img" style="width: 75px"
                                onerror="this.src=img2"
