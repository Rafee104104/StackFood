...
@section('content')
            ...
            <div class="row hero-content-main">
                <div class="col-lg-6 col-md-6 col-sm-12 hero-content responsive-ps ps-5 ">
                    ...
                    <div class="app-logo animate__animated animate__fadeInDown">
                        @if (!empty($landing_page_links['app_url_android_status']))
                            <a href="{{ $landing_page_links['app_url_android'] }}">
                                <img class="img-fluid" src="{{ asset('assets/landing/image/playstore.png') }}"
                                    alt="Play store" />
                            </a>
                        @endif
                        @if (!empty($landing_page_links['app_url_ios_status']))
                            <a href="{{ $landing_page_links['app_url_ios'] }}">
                                <img class="img-fluid" src="{{ asset('assets/landing/image/apple_store.png') }}"
                                    alt="iOS App">
                            </a>
                        @endif
                        @if (!empty($landing_page_links['web_app_url_status']))
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <img src="{{ asset('assets/landing/image/' . ($landing_page_images['top_content_image'] ?? 'home-banner-background.png')) }}"
                        onerror="this.src='{{ asset('assets/landing/image/home-banner-background.png') }}'"
                        alt="Hero Image" class="img-fluid hero-content-image animate__animated animate__bounceInRight" />
                </div>
            ...
            <div class="row about-section-row">
                <div class="col-lg-6 col-md-6 col-sm-12 about-us-left justify-content-center">
                     <img class="img-fluid animate__animated animate__fadeInDown about-us-image w-100"
                        src="{{ asset('assets/landing/image/'.(isset($landing_page_images['our-app-image']) ? $landing_page_images['our-app-image'] : 'our-app-image.png')) }}"
                        alt="Image" />
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 about-us-left">
                        <img class="img-fluid stuning-image w-100"
                            src="{{ asset('assets/landing/image/' . (isset($landing_page_images['feature_section_image']) ? $landing_page_images['feature_section_image'] : 'about_us_image.png')) }}"
                            alt="About us" />
                    </div>
                </div>
            </div>
    ...
    @endif
    <!-- Apps -->
    @if (!empty($landing_page_links['app_url_android_status']) || !empty($landing_page_links['app_url_ios_status']))
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 about-us-left">
                        <img class="img-fluid our-app-image w-100"
                            src="{{ asset('assets/landing/image/' . (isset($landing_page_images['mobile_app_section_image']) ? $landing_page_images['mobile_app_section_image'] : 'our_app_image.png')) }}"
                            alt="Image" />
                    </div>
                        ...
                        @foreach ($testimonial as $data)
                            <div class="col owl-item">
                                <div class="testimonial">
                                    <div class="pic">
                                        <img class="img-fluid"
                                            src="{{ asset('assets/landing/image/' . $data['img']) }}"
                                            alt="Image">
                                    </div>
