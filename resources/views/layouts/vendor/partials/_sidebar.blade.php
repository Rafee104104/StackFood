...
<div id="sidebarMain" class="d-none">
    <aside
        ...
        <div class="navbar-vertical-container">
            <script>
                const vendor_dashboard_url = "{{route('vendor.dashboard')}}";
            </script>
            <div class="navbar-brand-wrapper justify-content-center"
                onclick="location.href=vendor_dashboard_url"
            ...
            <div class="navbar-vertical-content text-capitalize" style="background-color: #213A36;">
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li class="nav-item {{Request::is('vendor-panel/order/list/pending') ? 'active' : ''}}">
                                <a class="nav-link " href="{{route('vendor.order.list', ['pending'])}}"
                                    ...
                                    <span class="text-truncate">
                                        ...
                                        {{(config('order_confirmation_model') == 'store' || optional(\App\CentralLogics\Helpers::get_store_data())->self_delivery_system) ? '' : translate('messages.take_away')}}
                                        <span class="badge badge-soft-success badge-pill ml-1">
                                            @if(config('order_confirmation_model') == 'store' || optional(\App\CentralLogics\Helpers::get_store_data())->self_delivery_system)
                            ...
                            <li class="nav-item {{Request::is('vendor-panel/order/list/all') ? 'active' : ''}}">
                                <a class="nav-link" href="{{route('vendor.order.list', ['all'])}}"
                                    title="{{translate('messages.all')}} {{translate('messages.order')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">
                            ...
                            ->where(function ($query) {
                                return $query->whereNotIn('order_status', (config('order_confirmation_model') == 'store' || optional(\App\CentralLogics\Helpers::get_store_data())->self_delivery_system) ? ['failed', 'canceled', 'refund_requested', 'refunded'] : ['pending', 'failed', 'canceled', 'refund_requested', 'refunded'])
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('vendor-panel/addon*') ? 'active' : ''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.addon.add-new')}}"
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('vendor-panel/category*') ? 'active' : ''}}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li class="nav-item {{ Request::is('vendor-panel/category/sub-category-list') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ route('vendor.category.sub-category-list') }}"
                    ...
                    {{--<li
                            class="navbar-vertical-aside-has-menu {{Request::is('vendor-panel/delivery-man/reviews/list')?'active':''}}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                        href="{{route('vendor.delivery-man.reviews.list')}}"
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('vendor/profile*') ? 'active' : ''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            href="{{route('vendor.profile.bankView')}}" title="{{translate('messages.bank_info')}}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('vendor/wallet*') ? 'active' : ''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.wallet.index')}}"
                            title="{{translate('messages.my')}} {{translate('messages.wallet')}}">
                            <i class="tio-table nav-icon"></i>
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('messages.my')}}
