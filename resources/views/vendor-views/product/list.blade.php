                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="media align-items-center"
                                                ...
                                                <img class="avatar avatar-lg mr-3"
                                                    src="{{$item['image'] ? asset('storage/product/' . $item['image']) : asset('assets/admin/img/160x160/img2.jpg')}}"
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$item->id}}">
                                                <input type="checkbox"
                                                    onclick="location.href='{{route('vendor.item.status', [$item['id'], $item->status ? 0 : 1])}}'"
                                                    class="toggle-switch-input" id="stocksCheckbox{{$item->id}}"
                                                    {{$item->status ? 'checked' : ''}}>
                                                <span class="toggle-switch-label">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-white" href="{{route('vendor.item.edit', [$item['id']])}}"
