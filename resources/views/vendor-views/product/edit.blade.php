...
<script>
    ...
    $("#customFileEg1").chaange(function() {
        readURL(this);
...
<script>
    ...
    var choice_title = "{{ translate('messages.choice_title') }}";
    var enter_choice_values = "{{ translate('messages.enter_choice_values') }}";


    function add_more_customer_choice_option(i, name) {
        let n = name;
        $('#customer_choice_options').append('<div class="row"><div class="col-md-3"><input type="hidden" name="choice_no[]" value="' + i + '"><input type="text" class="form-control" name="choice[]" value="' + n + '" placeholder="' + choice_title + '" readonly></div><div class="col-lg-9"><input type="text" class="form-control" name="choice_options_' + i + '[]" placeholder="' + enter_choice_values + '" data-role="tagsinput" onchange="combination_update()"></div></div>');
