...
@section('content')
    ...
    @push('script_2')
        ...
        <script
                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC84maVwolI74eAmifRNQPeLnV17p-GtdE&libraries=places,drawing&v=3.45.8"{{ \App\Models\BusinessSetting::where('key', 'map_api_key')->first()->value }}>
        </script>
        <script>
