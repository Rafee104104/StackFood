            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12"  style="max-height:250px; overflow-y: hidden;">
                         <img src="{{asset('storage/store/cover/'.$shop->cover_photo)}}" onerror="this.src='{{asset('public/assets/admin/img/900x400/img1.jpg')}}'" style="max-height:auto;width: 100%;">
                    </div>
                </div>
                @endif
                <div class="row mt-2">
                    ...
                    @else
                        ...
                        <div class="col-md-4">
                            <img src="{{asset('storage/store/'.$shop->logo)}}" class="rounded-circle border"
                            onerror="this.src='{{asset('assets/admin/img/160x160/img1.jpg')}}'"
